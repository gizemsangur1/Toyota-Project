                ...
                >
                  ...
                  <Grid container direction="row" id="buton" sx={{ mt:0.6}}>
                    <Grid
                      ...
                      sx={{  borderRadius: 1 }}
                    >
                      <Button sx={{ backgroundColor: "red",color: "white", borderRadius: 1,width:"100%" }} onClick={navigateToHataGiris}>
                        Giris
                      </Button>
                    </Grid>
                    <Grid
                      ...
                      sx={{ borderRadius: 1 }}
                    >
                      <Button onClick={Close} sx={{  backgroundColor: "black",color: "white", borderRadius: 1,width:"100% "}}>
                        Kapat
                      </Button>
                    </Grid>
                  </Grid>
